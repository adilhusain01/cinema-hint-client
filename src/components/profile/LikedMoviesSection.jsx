    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-xl font-semibold text-white">
          Liked Movies ({allLikedMovies.length})
        </h3>
      </div>
          ...
          <div key={movie.tmdbId} className="bg-white/5 rounded-xl overflow-hidden group">
            <div className="relative">
              {movie.posterPath ? (
                ...
                <div className="w-full h-64 bg-gradient-to-br from-green-500/20 to-emerald-500/20 flex items-center justify-center cursor-pointer"
                     onClick={() => onMovieClick(movie.tmdbId)}>
